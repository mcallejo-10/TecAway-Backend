...
const insertInitialUserData = async () => {
  ...
  const userKnowledgeData = [
    { user_id: 1, knowledge: 1 },
    { user_id: 1, knowledge: 2 },
    { user_id: 2, knowledge: 3 },
    { user_id: 2, knowledge: 9 },
    { user_id: 3, knowledge: 8 },
    { user_id: 3, knowledge: 5 },
    { user_id: 4, knowledge: 4 },
    { user_id: 4, knowledge: 3 },
    { user_id: 5, knowledge: 8 },
  ];
